...
namespace AZ
{
    ...
    //
    //=========================================================================
    constexpr Crc32::Crc32(const AZStd::string& view)
        : m_value{ 0 }
    {
        if (!view.empty())
        {
...
constexpr size_t strlen_ce(const char* start) {
   ...
   return end - start;
    ...
    constexpr Crc32::Crc32(const char* data)
        : m_value{ 0 }
    {
        Set(data, strlen_ce(data), true);
    }
    ...
    namespace Internal
    {
        template <AZ::u32 CrcValue>
        static constexpr AZ::Crc32 CompileTimeCrc32 = AZ::Crc32(CrcValue);
        ...
        constexpr void Crc32Set(const CharType* data, size_t size, bool forceLowerCase, AZ::u32& value)
        {
    ...
    // Crc32 - Add
    //=========================================================================
    constexpr void Crc32::Add(const AZStd::string& view)
    {
        if (!view.empty())
        {
