...
namespace AZ
{
    ...
    */
    ...
    namespace AzGenericTypeInfo
    {
        ...
        template<template<typename, AZStd::size_t> class>
    ...
    namespace Internal
    {
        ...
        struct HasAZTypeInfo
        {
            ...
            using type = typename AZStd::conditional<value, AZStd::true_type, AZStd::false_type>::type;
        };
...
#define AZ_TYPE_INFO_INTERNAL_AUTO__TYPE AZStd::size_t //cjh auto
...
//cjh    AZ_TYPE_INFO_INTERNAL_SPECIALIZE(AZStd::monostate, "{B1E9136B-D77A-4643-BE8E-2ABDA246AE0E}");
...
//cjh added
    AZ_TYPE_INFO_INTERNAL_SPECIALIZED_TEMPLATE_POSTFIX_UUID(AZStd::allocator,         "{7018DBB1-1330-4B55-8765-6D7C595CB151}", AZ_TYPE_INFO_INTERNAL_TYPENAME);
//cjh    AZ_TYPE_INFO_INTERNAL_SPECIALIZE(AZStd::any, "{D95C85CA-3399-4DA3-924C-BC9FF09DBA82}");
//
...
//cjh    AZ_TYPE_INFO_INTERNAL_SPECIALIZED_TEMPLATE_POSTFIX_UUID(AZStd::optional,            "{AB8C50C0-23A7-4333-81CD-46F648938B1C}", AZ_TYPE_INFO_INTERNAL_TYPENAME);
...
//cjh    AZ_TYPE_INFO_INTERNAL_SPECIALIZED_TEMPLATE_POSTFIX_UUID(AZStd::fixed_vector,        "{74044B6F-E922-4FD7-915D-EFC5D1DC59AE}", AZ_TYPE_INFO_INTERNAL_TYPENAME, AZ_TYPE_INFO_INTERNAL_AUTO);
...
//cjh    template <typename Element, size_t MaxElementCount, typename Traits>
...
//cjh    static constexpr const char* s_variantTypeId{ "{1E8BB1E5-410A-4367-8FAA-D43A4DE14D4B}" };
