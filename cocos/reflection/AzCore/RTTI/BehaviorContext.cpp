...
//cjh #include <AzCore/Component/EntityBus.h>
...
//    }
    ...
    BehaviorContext::GlobalMethodBuilder::~GlobalMethodBuilder()
    {
        ...
        if (m_method)
        {
//cjh            if (MethodReturnsAzEventByReferenceOrPointer(*m_method))
//            {
...
//cjh            if (m_prop->m_getter && MethodReturnsAzEventByReferenceOrPointer(*m_prop->m_getter))
//            {
...
//cjh        auto ebuses = AZStd::move(m_ebuses);
...
//        }
    ...
    {
//cjh        if (Attribute* attribute = AZ::FindAttribute(ScriptCanvasAttributes::CheckedOperation, method.m_attributes))
//        {
...
//                else
//                {
//                    const_cast<decltype(overloadIter->m_overloads)*>(&overloadIter->m_overloads)->push_back({&method, this});//cjh add const_cast
//                }
//            }
//        }
    }
    ...
    void* BehaviorClass::Allocate() const
    {
        ...
        {
//cjh            return azmalloc(m_size, m_alignment, AZ::SystemAllocator, m_name.c_str());
    ...
    void  BehaviorClass::Deallocate(void* address) const
    {
        ...
        {
//cjh            azfree(address, AZ::SystemAllocator, m_size, m_alignment);
            free(address);
        }
    }
