...
//cjh #include <AzCore/ScriptCanvas/ScriptCanvasAttributes.h>
//cjh #include <AzCore/ScriptCanvas/ScriptCanvasOnDemandNames.h>
...
//cjh                    && AZStd::is_same_v<Allocator, AZStd::allocator>;
            if /*cjh constexpr*/ (is_string)
            {
...
//cjh                        ->Attribute(AZ::ScriptCanvasAttributes::ExplicitOverloadCrc, ExplicitOverloadInfo("Erase", "Containers"))
...
//                        ->Attribute(AZ::ScriptCanvasAttributes::OverloadArgumentGroup, AZ::OverloadArgumentGroupInfo({ "ContainerGroup", "" }, { "ContainerGroup" }))
                    ...
                    ->Method("PushBack_VM", &PushBack_VM, { { { "Container", "The container into which to add an element to", nullptr, {} }, { "Value", "The value to be added", nullptr, {} } } })
                        ->Attribute(AZ::Script::Attributes::TreatAsMemberFunction, AZ::AttributeIsValid::IfPresent)
//cjh                        ->Attribute(AZ::ScriptCanvasAttributes::ExplicitOverloadCrc, ExplicitOverloadInfo("Add Element at End", "Containers"))
//                        ->Attribute(AZ::ScriptCanvasAttributes::OverloadArgumentGroup, AZ::OverloadArgumentGroupInfo({ "ContainerGroup", "" }, { "ContainerGroup" }))
                    ...
                    ->template Method<typename ContainerType::reference(ContainerType::*)(typename ContainerType::size_type)>
                        ...
                        ->Attribute(AZ::Script::Attributes::Deprecated, true)
//cjh                    ->template Method<typename ContainerType::reference(ContainerType::*)(typename ContainerType::size_type)>(k_accessElementNameUnchecked, &ContainerType::at, { { { "Index", "The index to read from", nullptr } } })
//cjh                        ->Attribute(AZ::ScriptCanvasAttributes::ExplicitOverloadCrc, ExplicitOverloadInfo("Get Element", "Containers"))
...
//cjh                        ->Attribute(AZ::ScriptCanvasAttributes::ExplicitOverloadCrc, ExplicitOverloadInfo("Get Size", "Containers"))
                        ->Attribute(AZ::Script::Attributes::TreatAsMemberFunction, AZ::AttributeIsValid::IfPresent)
                    ->Method("clear", &ContainerType::clear)
//cjh                    ->template Method<typename ContainerType::reference(ContainerType::*)(typename ContainerType::size_type)>(k_accessElementName, &ContainerType::at, { { { "Index", "The index to read from", nullptr, BehaviorParameter::Traits::TR_INDEX } } })
                    ...
                    ->Method("Clear", [](ContainerType& thisContainer)->ContainerType& { thisContainer.clear(); return thisContainer; }, { { { "Container", "The container to clear", nullptr, {} } } })
                        ->Attribute(AZ::Script::Attributes::TreatAsMemberFunction, AZ::AttributeIsValid::IfPresent)
//cjh                        ->Attribute(AZ::ScriptCanvasAttributes::ExplicitOverloadCrc, ExplicitOverloadInfo("Clear All Elements", "Containers"))
//                        ->Attribute(AZ::ScriptCanvasAttributes::OverloadArgumentGroup, AZ::OverloadArgumentGroupInfo({ "ContainerGroup" }, { "ContainerGroup" }))
//cjh                    ->Method("Empty", &ContainerType::empty, { { { "Container", "The container to check if it is empty", nullptr, {} } } })
...
//cjh                    ->template Method<typename ContainerType::reference(ContainerType::*)()>("Back", &ContainerType::back, { { { "Container", "The container to get the last element from", nullptr, {} } } })
...
//                        ->Attribute(AZ::ScriptCanvasAttributes::CheckedOperation, CheckedOperationInfo("NotEmpty", {}, "Out", "Empty"))
                    ...
                    ->Method("Insert", &Insert, { { { "Container", "The container into which to insert the value", nullptr, {} }, { "Index", "The index at which to insert the value", nullptr, {} }, { "Value", "The value that is to be inserted", nullptr, {} } } })
                        ->Attribute(AZ::Script::Attributes::TreatAsMemberFunction, AZ::AttributeIsValid::IfPresent)
//cjh                        ->Attribute(AZ::ScriptCanvasAttributes::ExplicitOverloadCrc, ExplicitOverloadInfo("Insert", "Containers"))
                        ->Attribute(AZ::Script::Attributes::ExcludeFrom, AZ::Script::Attributes::ExcludeFlags::All)
//                        ->Attribute(AZ::ScriptCanvasAttributes::OverloadArgumentGroup, AZ::OverloadArgumentGroupInfo({ "ContainerGroup", "", "" }, { "ContainerGroup" }))
...
//cjh                    ->Method(k_sizeName, [](ContainerType& thisPtr) { return aznumeric_cast<int>(thisPtr.size()); })
                    ->Method("Swap", static_cast<void(ContainerType::*)(ContainerType&)>(&ContainerType::swap))
//cjh                    ->Method(k_iteratorConstructorName, &Iterate_VM)
                    ;
                ...
                behaviorContext->Class<ValueIteratorType>()
                    ...
                    ->Attribute(AZ::Script::Attributes::Storage, AZ::Script::Attributes::StorageType::ScriptOwn)
                    ->Attribute(AZ::Script::Attributes::EnableAsScriptEventParamType, &IsScriptEventType)
//cjh                    ->Method(k_iteratorIsNotAtEndName, &ValueIteratorType::IsNotAtEnd)
...
//cjh                    ->Method(k_accessElementName, &At, {{ {}, { "Index", "The index to read from", nullptr, BehaviorParameter::Traits::TR_INDEX }}})
        ...
        static void Reflect(ReflectContext* context)
        {
            if (BehaviorContext* behaviorContext = azrtti_cast<BehaviorContext*>(context))
            {
                ...
                behaviorContext->Class<OutcomeType>()
                    ...
                    ->Attribute(AZ::Script::Attributes::ExcludeFrom, AZ::Script::Attributes::ExcludeFlags::All)
//cjh                    ->Attribute(AZ::ScriptCanvasAttributes::PrettyName, &ScriptCanvasOnDemandReflection::OnDemandPrettyName<OutcomeType>::Get)
...
//cjh                    ->Attribute(AZ::ScriptCanvasAttributes::AllowInternalCreation, AttributeIsValid::IfPresent)
...
//cjh                        ->Attribute(AZ::ScriptCanvasAttributes::TupleGetFunctionIndex, 0)
                    ->Method("GetError", getErrorFunc)
//cjh                        ->Attribute(AZ::ScriptCanvasAttributes::TupleGetFunctionIndex, 1)
        ...
        static void Reflect(ReflectContext* context)
        {
            if (BehaviorContext* behaviorContext = azrtti_cast<BehaviorContext*>(context))
            {
                ...
                behaviorContext->Class<OutcomeType>()
                    ->Attribute(AZ::Script::Attributes::Scope, AZ::Script::Attributes::ScopeFlags::Common)
                    ->Attribute(AZ::Script::Attributes::ExcludeFrom, AZ::Script::Attributes::ExcludeFlags::All)
//cjh                    ->Attribute(AZ::ScriptCanvasAttributes::AllowInternalCreation, true)
...
//cjh                    ->Attribute(AZ::ScriptCanvasAttributes::PrettyName, ScriptCanvasOnDemandReflection::OnDemandPrettyName<ContainerType>::Get(*behaviorContext))
                    ->Attribute(AZ::Script::Attributes::ToolTip, ScriptCanvasOnDemandReflection::OnDemandToolTip<ContainerType>::Get(*behaviorContext))
                    ->Attribute(AZ::Script::Attributes::Category, ScriptCanvasOnDemandReflection::OnDemandCategoryName<ContainerType>::Get(*behaviorContext))
//cjh                    ->Attribute(AZ::ScriptCanvasAttributes::VariableCreationForbidden, AttributeIsValid::IfPresent)
                    ->Attribute(AZ::Script::Attributes::Storage, AZ::Script::Attributes::StorageType::Value)
...
//cjh                ->Attribute(AZ::ScriptCanvasAttributes::TupleGetFunctionIndex, Index)
                ;
...
//cjh        template<typename... Targ, size_t... Indices>
...
//        }
        ...
        static void Reflect(ReflectContext* context)
        {
            if (BehaviorContext* behaviorContext = azrtti_cast<BehaviorContext*>(context))
            {
//cjh                AZ::ScriptCanvasAttributes::GetUnpackedReturnValueTypesHolder unpackFunctionHolder;
...
//cjh                ReflectUnpackMethods<T...>(builder, AZStd::make_index_sequence<sizeof...(T)>{});
...
//cjh                    ->Attribute(AZ::ScriptCanvasAttributes::PrettyName, ScriptCanvasOnDemandReflection::OnDemandPrettyName<ContainerType>::Get(*behaviorContext))
                    ...
                    ->Attribute(AZ::Script::Attributes::Category, ScriptCanvasOnDemandReflection::OnDemandCategoryName<ContainerType>::Get(*behaviorContext))
                    ->Attribute(AZ::Script::Attributes::Storage, AZ::Script::Attributes::StorageType::ScriptOwn)
//cjh                    ->Method(k_accessElementName, &At)
                        ->Attribute(AZ::Script::Attributes::TreatAsMemberFunction, AZ::AttributeIsValid::IfPresent)
//cjh                        ->Attribute(AZ::ScriptCanvasAttributes::CheckedOperation, CheckedOperationInfo("contains", {}, "Out", "Key Not Found"))
...
//cjh                        ->Attribute(AZ::ScriptCanvasAttributes::ExplicitOverloadCrc, ExplicitOverloadInfo("Is Empty", "Containers"))
//                        ->Attribute(AZ::ScriptCanvasAttributes::BranchOnResult, emptyBranchInfo)
...
//cjh                        ->Attribute(AZ::ScriptCanvasAttributes::ExplicitOverloadCrc, ExplicitOverloadInfo("Has Key", "Containers"))
                        ->Attribute(AZ::Script::Attributes::TreatAsMemberFunction, AZ::AttributeIsValid::IfPresent)
...
//                    ->Method(k_iteratorConstructorName, &Iterate_VM)
                ...
                behaviorContext->Class<ValueIteratorType>()
                    ->Attribute(AZ::Script::Attributes::ExcludeFrom, AZ::Script::Attributes::ExcludeFlags::ListOnly)
                    ->Attribute(AZ::Script::Attributes::Storage, AZ::Script::Attributes::StorageType::ScriptOwn)
//cjh                    ->Method(k_iteratorGetKeyName, &ValueIteratorType::GetKeyUnchecked)
//                    ->Method(k_iteratorModValueName, &ValueIteratorType::ModValueUnchecked)
